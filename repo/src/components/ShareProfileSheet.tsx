...
import { Share, X, Download, Copy, MessageCircle, Twitter, Facebook, Send, Linkedin, Mail, MoreHorizontal, Zap, Users, Camera, Lock, PlaySquare, ArrowLeft } from 'lucide-react';
...
const THEMES = [
  { id: 'neon', name: '🔮 Neon', gradient: 'from-[#B026FF] to-[#00F0FF]', qr: '#B026FF', qrBg: 'transparent', glow: 'shadow-[0_0_20px_rgba(176,38,255,0.4)]' },
  { id: 'ocean', name: '🌊 Ocean', gradient: 'from-[#00F0FF] to-[#0066FF]', qr: '#00F0FF', qrBg: 'transparent', glow: 'shadow-[0_0_20px_rgba(0,240,255,0.4)]' },
  { id: 'blaze', name: '🔥 Blaze', gradient: 'from-[#FF3366] to-[#FF9933]', qr: '#FF3366', qrBg: 'transparent', glow: 'shadow-[0_0_20px_rgba(255,51,102,0.4)]' },
  { id: 'vibe', name: '💜 Vibe', gradient: 'from-[#8A2BE2] to-[#FF69B4]', qr: '#8A2BE2', qrBg: 'transparent', glow: 'shadow-[0_0_20px_rgba(138,43,226,0.4)]' },
  { id: 'nova', name: '⭐ Nova', gradient: 'from-[#FFD700] to-[#FF8C00]', qr: '#FFD700', qrBg: 'transparent', glow: 'shadow-[0_0_20px_rgba(255,215,0,0.4)]' },
  { id: 'dark', name: '🌙 Dark', gradient: 'from-[#222] to-[#111]', qr: '#FFFFFF', qrBg: 'transparent', glow: 'shadow-[0_0_20px_rgba(255,255,255,0.1)]' },
];
                ...
                >
                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    <div className="flex gap-3">
                      <button className="flex-1 py-3 bg-white/5 hover:bg-white/10 border border-white/10 rounded-xl font-bold text-sm text-white flex items-center justify-center gap-2 transition-colors">
                  ...
                  <div className="flex flex-col items-center justify-center py-6 px-4 bg-white/5 border border-white/10 rounded-3xl relative overflow-hidden">
                    ...
                    <div className="bg-transparent p-4 rounded-2xl relative z-10 flex flex-col items-center group">
                      <div className={`p-4 bg-white/5 rounded-2xl border border-white/10 backdrop-blur-md transition-shadow relative ${activeTheme.glow}`}>
                        <QRCodeSVG 
                      ...
                      <button className="mt-4 px-6 py-2.5 bg-white/10 hover:bg-white/20 rounded-full text-xs font-bold text-white flex items-center gap-2 transition-colors border border-white/10">
                  ...
                  <div className="flex flex-col gap-3 pt-2">
                    <button className="w-full flex items-center gap-4 bg-gradient-to-r from-neon-purple/20 to-neon-blue/20 hover:from-neon-purple/30 hover:to-neon-blue/30 border border-neon-purple/30 p-4 rounded-2xl transition-all group">
                      <div className="w-10 h-10 rounded-full bg-neon-purple/20 flex items-center justify-center group-hover:scale-110 transition-transform">
                        <PlaySquare className="w-5 h-5 text-neon-purple fill-neon-purple" />
                      </div>
                      <div className="flex flex-col items-start">
                        <span className="text-white font-bold">Share as Pulse Story</span>
                        <span className="text-xs text-gray-400">Post your card to your Sparks</span>
                      </div>
                    </button>
                    
                    <button className="w-full flex items-center gap-4 bg-white/5 border border-white/10 hover:bg-white/10 p-4 rounded-2xl transition-all group">
                      <div className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center group-hover:scale-110 transition-transform">
                        <Lock className="w-5 h-5 text-gray-300" />
                      </div>
                      <div className="flex flex-col items-start">
                        <span className="text-white font-bold">Share via Veil</span>
                        <span className="text-xs text-gray-400">Send privately in encrypted chat</span>
                      </div>
                    </button>
                    ...
                    <button className="w-full flex items-center gap-4 bg-white/5 border border-white/10 hover:bg-white/10 p-4 rounded-2xl transition-all group">
                      ...
                      <div className="flex flex-col items-start">
                        <span className="text-white font-bold">Share to Community</span>
                        <span className="text-xs text-gray-400">Post card in a community</span>
                      </div>
                    </button>
