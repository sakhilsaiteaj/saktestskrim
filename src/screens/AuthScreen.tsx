...
export default function AuthScreen() {
  ...
  const handleBioChange = (e: React.ChangeEvent<HTMLTextAreaElement>) => {
    const text = e.target.value.substring(0, 150);
    setBio(text);
    const detected = detectTextLanguage(text);
    if (detected) saveProfileLanguage(detected);
  };
            ...
            <div className="flex-1 overflow-y-auto no-scrollbar pt-16 lg:flex-none lg:overflow-visible lg:pt-0">
              ...
              <form onSubmit={handleSignup} className="space-y-4">
                <div>
                  ...
                  <input type="text" value={fullName} onChange={handleNameChange} placeholder="Bappu Bhai Sharma" className="w-full bg-skrim-surface border border-gray-800 rounded-xl px-4 py-3 mt-1 focus:outline-none focus:border-neon-purple focus:ring-1 focus:ring-neon-purple/50 transition-all text-white" />
                </div>
                <div>
