...
import { Zap, Crown, Flame, Target, Home, Compass, PlaySquare, MessageCircle, User, Users, Bell, Lock, Settings, LogOut } from 'lucide-react';
    ...
    <div className="flex flex-col flex-1 h-full px-4 py-4 relative z-50 overflow-hidden">
       ...
       <div className="flex flex-col items-start pb-4 hover:bg-white/5 transition rounded-xl p-2 cursor-pointer active:scale-95">
          <div className="flex items-center gap-2">
             ...
             <h1 className="text-xl font-black text-white tracking-tight drop-shadow-[0_0_8px_rgba(255,255,255,0.3)]">SkrimChat</h1>
          </div>
          <p className="text-[10px] text-gray-400 font-bold tracking-widest uppercase mt-1">Connect. Create. Converse.</p>
       </div>
       ...
       <div className="mt-3 overflow-y-auto no-scrollbar pb-6 flex-1 flex flex-col">
         <div className="flex flex-col gap-[4px]">
           ...
           <SidebarNavItem icon={Users} label="Communities" path="/communities" badge={5} delay={0.3} />
           
           <div className="pt-3 pb-1 px-3">
             <span className="text-[10px] uppercase text-[#444] tracking-[1.5px]">PRIVATE</span>
           </div>
           
           <SidebarNavItem icon={Bell} label="Signal" path="/signal" badge={8} delay={0.35} />
           <SidebarNavItem icon={Settings} label="Settings" path="/settings" delay={0.4} />
           <SidebarNavItem icon={Lock} label="Veil" path="/veil" isVeil={true} chip="E2E" delay={0.45} />
         </div>
       </div>
    </div>
  );
