              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-3 text-sm">
                  ...
                  <div className="bg-white/5 border border-white/10 p-3 rounded-xl flex flex-col items-center">
                    ...
                    <span className="text-green-400 font-bold text-lg mt-1">Today ✅</span>
                  </div>
                </div>
                ...
                <div className="space-y-3 pt-2">
                  ...
                  <div className="space-y-2 text-sm text-gray-300 bg-white/5 p-4 rounded-xl border border-white/10">
                    <div className="flex justify-between items-center"><span>📸 Post a photo/reel</span><span>✅</span></div>
                    <div className="flex justify-between items-center"><span>✨ Add a Spark story</span><span>✅</span></div>
                    <div className="flex justify-between items-center"><span>💬 Send a message</span><span>✅</span></div>
                    <div className="flex justify-between items-center"><span>⚡ Pulse someone's post</span><span>✅</span></div>
                    <div className="flex justify-between items-center"><span>👀 Watch 3 Vibes</span><span>✅</span></div>
                  </div>
                </div>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3 pt-6">
                  ...
                  <div className="grid grid-cols-2 gap-2 text-xs text-gray-300 font-medium">
                    <div className="bg-white/5 p-2.5 rounded-lg flex items-center gap-2">✅ Post quality</div>
                    <div className="bg-white/5 p-2.5 rounded-lg flex items-center gap-2">✅ Reply to comments</div>
                    <div className="bg-white/5 p-2.5 rounded-lg flex items-center gap-2">✅ Never get reported</div>
                    <div className="bg-white/5 p-2.5 rounded-lg flex items-center gap-2">✅ Get more shares</div>
                  </div>
                </div>
